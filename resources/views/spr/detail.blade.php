...
<div id="printableArea" class="container bordered bg-white">
    <div class="row">
        <div class="col-1"></div>
        <div class="col-10">
            <div class="row">
            ...
            <div class="row">
                <div class="col-8 bordered" style="height: 200px;">
                    ...
                    <div style="margin-top: 60px;">
                        <td colspan="2" style="height: 10vh;">Kondisi Mesin:<br>{{ $barang->status_kerusakan }}</td>
                    </div>
                </div>
...
<div class="row justify-content-center">
    <div class="col-md-10 text-center">
        ...
        <a href="{{ route('spr_pdf', ['nomor_spr' => $barang->nomor_spr]) }}" class="btn btn-success btn-sm">Cetak
            PDF</a>
        <button class="btn btn-success btn-sm" onclick="printPage()">Cetak Halaman</button>
    </div>
</div>
