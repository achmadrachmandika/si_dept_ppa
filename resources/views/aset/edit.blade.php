...
<div class="container bg-white">
    ...
    <div class="card-body">
        ...
        <form method="post" action="{{ route('aset.update',$aset->no_unit) }}" id="myForm">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="no_unit" value="{{$aset->no_unit}}" readonly>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label class="h5" for="equipment">Equipment</label>
                        <input class="form-control" type="text" name="equipment" value="{{$aset->equipment}}">
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label class="h5" for="no_aset">No Aset</label>
                        <input class="form-control" type="text" name="no_aset" value="{{$aset->no_aset}}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nama_unit" value="{{$aset->nama_unit}}">
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label class="h5" for="tipe">Tipe</label>
                        <input class="form-control" type="text" name="tipe" value="{{$aset->tipe}}">
                    </div>
                </div>
            </div>
