        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header" style="background-color: rgb(41, 48, 66); color: white;">
                    <h2 class="font-weight-bold mb-0" style="font-family: 'Your Chosen Font', sans-serif;">Edit
                        Sparepart</h2>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_material" value="{{ $sparepart->nama_material }}"
                                        class="form-control" placeholder="Nama Material">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 text-center">
                                    <a class="btn btn-outline-primary" href="{{ route('spareparts.index') }}">
                                        Kembali</a>
                                </div>
                            </div>
                        </div>
