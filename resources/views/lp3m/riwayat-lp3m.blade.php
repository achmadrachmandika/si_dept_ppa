                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex">
                                ...
                                <button onclick="window.location.href='{{ url('/lp3m') }}'" class="btn btn-success ml-1"
                                    type="button"><span class="h6">Tambah</span></button>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form method="POST" action="{{ url('delete-lp3m/'.$data->no_spr) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{url('show-lp3m/'.$data->no_spr)}}"
                                                        class="btn btn-outline-info mb-1">Show</a>
                                                    <a href="{{url('edit-lp3m/'.$data->no_spr)}}"
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        ...
                                                        @for ($i = 1; $i <= $datas->lastPage(); $i++)
                                                            <li
                                                                ...
                                                                <a class="page-link" href="{{ $datas->url($i) }}">{{ $i
                                                                    }}</a>
                                                            </li>
                                                            @endfor
